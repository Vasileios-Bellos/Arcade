classdef Asteroids < GameBase
    %Asteroids  Wireframe asteroid field with auto-fire and splitting.
    %   Ship follows finger position. Auto-fires at nearest asteroid every
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.ShipTrailH = line(ax, NaN, NaN, "Color", [obj.ColorCyan, 0.4], ...
                "LineWidth", 1 * ps, "Tag", "GT_asteroids");
        ...
        function onCleanup(obj)
            ...
            % Orphan guard
            GameBase.deleteTaggedGraphics(obj.Ax, "^GT_asteroids");
        end
    ...
    methods (Access = private)
        ...
        function createRock(obj, ax, x, y, vx, vy, rockRadius, tier)
            ...
            pH = patch(ax, "XData", px, "YData", py, ...
                ...
                "EdgeColor", clr, "LineWidth", 0.8 * obj.getPixelScale(), "Tag", "GT_asteroids");
