classdef OrbitalDefense < engine.GameBase
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            for k = 1:10
                obj.IntPoolLine{k} = line(ax, NaN, NaN, ...
                    "Color", obj.ColorCyan, "LineWidth", 0.5 * obj.FontScale, ...
            ...
            for k = 1:12
                ...
                obj.ExpPoolPatch{k} = patch(ax, "XData", cosT, ...
                    ...
                    "EdgeColor", obj.ColorGold, "LineWidth", 0.5 * obj.FontScale, ...
                    "Visible", "off", "Tag", "GT_orbitaldefense");
            end
            ...
            for k = 1:50
                obj.AstPoolPatch{k} = patch(ax, "XData", NaN, "YData", NaN, ...
                    ...
                    "EdgeColor", obj.ColorSilver, "LineWidth", 0.8 * obj.FontScale, ...
                    "Visible", "off", "Tag", "GT_orbitaldefense");
                obj.AstShapeX{k} = [];
                obj.AstShapeY{k} = [];
            end
        ...
        function onCleanup(obj)
            ...
            % Orphan guard
            engine.GameBase.deleteTaggedGraphics(obj.Ax, "^GT_orbitaldefense");
        end
