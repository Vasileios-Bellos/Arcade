    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.BallInfoTextH = text(ax, cx, cy*0.7 - r - 8, "HIT ME UP!", ...
                "Color", [obj.ColorCyan, 0.8], "FontSize", 10, "FontWeight", "bold", ...
            ...
            obj.DeathLineH = line(ax, [dx(1), dx(2)], [dangerY, dangerY], ...
                "Color", [obj.ColorRed, 0.25], "LineWidth", 2, ...
    ...
    methods (Access = private)
        ...
        function renderBall(obj)
            ...
            if ~isempty(obj.BallAuraH) && isvalid(obj.BallAuraH)
                ...
                obj.BallAuraH.MarkerSize = round(50 * auraScale);
            ...
            if obj.TrailIdx > 0
                ...
                trailWidth = min(4, 1.5 + ballSpeed * 0.15);
        ...
        function updateExtraBalls(obj, fingerPos, avgVel)
            ...
            for bi = 1:nExtra
                ...
                if ~isempty(h) && isvalid(h)
                    ...
                    h.MarkerSize = round(50 * auraScale);
                    h.Color = [clr, 0.12];
                end
                % Trail
                ...
                if tIdx > 0
                    ...
                    trailWidth = min(4, 1.5 + extraSpeed * 0.15);
