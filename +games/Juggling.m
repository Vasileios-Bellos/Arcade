    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.BallTrailGlowH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.12], "LineWidth", 4.3 * ps, ...
                "Tag", "GT_juggle");
            obj.BallTrailH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.5], "LineWidth", 1.35 * ps, ...
                "Tag", "GT_juggle");
            obj.BallAuraH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.15], "Marker", ".", ...
                "MarkerSize", 27 * ps, "LineStyle", "none", "Tag", "GT_juggle");
            glowSize = r * 2.5 * ps;
            ...
            obj.BallCoreH = line(ax, cx, cy*0.7, ...
                "Color", [1, 1, 1, 1], "Marker", ".", "MarkerSize", 10 * ps, ...
                "LineStyle", "none", "Tag", "GT_juggle");
            obj.BallInfoTextH = text(ax, cx, cy*0.7 - r - 8, "HIT ME UP!", ...
                "Color", [obj.ColorCyan, 0.8], "FontSize", 5.4 * ps, "FontWeight", "bold", ...
            ...
            obj.DeathLineH = line(ax, [dx(1), dx(2)], [dangerY, dangerY], ...
                "Color", [obj.ColorRed, 0.25], "LineWidth", 1.1 * ps, ...
