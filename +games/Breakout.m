classdef Breakout < engine.GameBase
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.BallTrailGlowH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.12], "LineWidth", 4 * obj.FontScale, ...
                "LineStyle", "-", "Tag", "GT_breakout");
            obj.BallTrailH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.5], "LineWidth", 1.3 * obj.FontScale, ...
                "LineStyle", "-", "Tag", "GT_breakout");
            ...
            obj.PaddleGlowH = patch(ax, ...
                ...
                "EdgeColor", obj.ColorCyan * 0.3, "LineWidth", 2.7 * obj.FontScale, ...
                "Tag", "GT_breakout");
            obj.PaddleH = patch(ax, ...
                [cx - pw/2, cx + pw/2, cx + pw/2, cx - pw/2], ...
                [py, py, py + ph, py + ph], ...
                obj.ColorCyan, "FaceAlpha", 0.35, ...
                "EdgeColor", obj.ColorCyan, "LineWidth", 1.1 * obj.FontScale, ...
                "Tag", "GT_breakout");
            ...
            obj.LevelTextH = text(ax, cx, mean(dy), "", ...
                "Color", obj.ColorGold, "FontSize", 39 * obj.FontScale, ...
                "FontWeight", "bold", "HorizontalAlignment", "center", ...
                "VerticalAlignment", "middle", "Visible", "off", ...
                "Tag", "GT_breakout");
        ...
        function onCleanup(obj)
            ...
            % Orphan guard
            engine.GameBase.deleteTaggedGraphics(obj.Ax, "^GT_breakout");
        end
            ...
            for rowIdx = 1:nRows
                for colIdx = 1:nCols
                    ...
                    patchH = patch(ax, xv, yv, brickColor, ...
                        ...
                        "LineWidth", 0.65 * bps, "Tag", "GT_breakout");
    ...
    methods (Access = private)
        function spawnPowerUp(obj, x, y)
            ...
            patchH = patch(ax, x + capR*cos(theta), y + capR*sin(theta), ...
                ...
                "LineWidth", 0.8 * pups, "Tag", "GT_breakout");

            % Label
            textH = text(ax, x, y, char(pType), "Color", [1, 1, 1], ...
                "FontSize", 8 * pups, "FontWeight", "bold", ...
        ...
        function spawnExtraBalls(obj)
            ...
            for sIdx = 1:numel(sources)
                ...
                for aIdx = 1:2
                    ...
                    tgH = line(ax, NaN, NaN, ...
                        "Color", [obj.ColorCyan, 0.08], "LineWidth", 2.7 * ebps, "Tag", "GT_breakout");
