classdef FpsRailShooter < GameBase
    %FpsRailShooter  House of the Dead style pseudo-3D rail shooter.
    ...
    %
    %   Standalone: games.FpsRailShooter().play()
    %   Hosted:     GameHost registers this and calls onInit/onUpdate/onCleanup
    %
    %   See also GameBase, GameHost

    properties (Constant)
        Name = "FPS Rail Shooter"
    end
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            for g = 1:nGrid
                ...
                obj.GridLinesH(g) = line(ax, [vpX, endX], [vpY, endY], ...
                    "Color", [0.15, 0.25, 0.35, 0.12], "LineWidth", 1, ...
                    "LineStyle", "-", "Tag", "GT_fpsrailshooter");
            end

            % --- Ground plane indicator ---
            groundY = dy(2) - areaH * 0.08;
            obj.GroundLineH = line(ax, [dx(1), dx(2)], [groundY, groundY], ...
                "Color", [0.1, 0.4, 0.5, 0.25], "LineWidth", 2, ...
                "Tag", "GT_fpsrailshooter");

            % --- Crosshair: glow + inner cross + red center dot + ring ---
            obj.CrossGlowH = line(ax, NaN(1,8), NaN(1,8), ...
                "Color", [obj.ColorGold, 0.25], "LineWidth", 5, "Tag", "GT_fpsrailshooter");
            obj.CrossH = line(ax, NaN(1,8), NaN(1,8), ...
                "Color", obj.ColorGold, "LineWidth", 1.5, "Tag", "GT_fpsrailshooter");
            obj.CrossDotH = scatter(ax, NaN, NaN, 30, [1, 0.15, 0.1], ...
                "filled", "MarkerFaceAlpha", 0.95, "Tag", "GT_fpsrailshooter");
            obj.CrossRingH = scatter(ax, NaN, NaN, 6000, ...
                "MarkerEdgeColor", "r", "LineWidth", 1.5, ...
                "MarkerFaceColor", "none", "Tag", "GT_fpsrailshooter");
            ...
            obj.LivesTextH = text(ax, dx(1) + 8, dy(1) + 14, ...
                livesStr, ...
                "Color", obj.ColorCyan, "FontSize", 11, "FontWeight", "bold", ...
                "Tag", "GT_fpsrailshooter");

            % --- HUD: Wave (top-center, bold) ---
            obj.WaveTextH = text(ax, mean(dx), dy(1) + 14, ...
                sprintf("WAVE %d", obj.Wave), ...
                "Color", obj.ColorGold, "FontSize", 14, "FontWeight", "bold", ...
                "HorizontalAlignment", "center", "Tag", "GT_fpsrailshooter");
        ...
        function onCleanup(obj)
            ...
            % Orphan guard
            GameBase.deleteTaggedGraphics(obj.Ax, "^GT_fpsrailshooter");
        end
        ...
        function r = getResults(obj)
            %getResults  Return FPS rail shooter results.
            r.Title = "FPS RAIL SHOOTER";
            if obj.Lives <= 0
                statusStr = "GAME OVER";
            else
    ...
    methods (Access = private)
        ...
        function spawnMonster(obj, mType)
            ...
            [shapeX, shapeY] = games.FpsRailShooter.monsterShape(mType);
            ...
            bodyPatchH = patch(ax, scrX + shapeX * bodySize, ...
                ...
                "LineWidth", 2, "Tag", "GT_fpsrailshooter");

            % Glow patch
            glowPatchH = patch(ax, scrX + shapeX * bodySize, ...
                scrY + shapeY * bodySize, faceCol, ...
                "FaceAlpha", 0.1, "EdgeColor", faceCol, ...
                "EdgeAlpha", 0.45, "LineWidth", 5, "Tag", "GT_fpsrailshooter");
            ...
            if mType == 4
                ...
                bossNameH = text(ax, scrX, barY - 4, "DREADNOUGHT", ...
                    ...
                    "VerticalAlignment", "bottom", "Tag", "GT_fpsrailshooter");
            end
            ...
            switch mType
                case 1  % Fighter: center spine line
                    ...
                    ribsH(1) = line(ax, ...
                        ...
                        "Color", [faceCol, detailAlpha], "LineWidth", 1, ...
                        "Tag", "GT_fpsrailshooter");
                case 2  % Cruiser: horizontal rib lines (3 ribs)
                    ...
                    ribsH(1) = line(ax, ...
                        ...
                        "Color", [faceCol, detailAlpha], "LineWidth", 1.5, ...
                        "Tag", "GT_fpsrailshooter");
                    ribYs = [-0.15, 0.1, 0.3];
                    for r = 1:3
                        ribsH(r + 1) = line(ax, ...
                ...
                case 3  % Interceptor: wing strut lines
                    ...
                    ribsH(1) = line(ax, ...
                        ...
                        "Color", [faceCol, detailAlpha * 1.2], "LineWidth", 1, ...
                        "Tag", "GT_fpsrailshooter");
                    ribsH(2) = line(ax, ...
                        [scrX + 0.1 * bodySize, scrX + 0.6 * bodySize], ...
                        [scrY - 0.2 * bodySize, scrY - 0.5 * bodySize], ...
                ...
                case 4  % Dreadnought: cross pattern (spine + shoulder line)
                    ...
                    ribsH(1) = line(ax, ...
                        ...
                        "Color", [faceCol, detailAlpha], "LineWidth", 2, ...
                        "Tag", "GT_fpsrailshooter");
                    ribsH(2) = line(ax, ...
                        [scrX - 0.5 * bodySize, scrX + 0.5 * bodySize], ...
