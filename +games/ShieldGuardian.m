classdef ShieldGuardian < engine.GameBase
    %ShieldGuardian  Rotate a shield arc to deflect projectiles from a core orb.
    %   Shield faces the cursor. Deflected projectiles chain-destroy others.
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.ShieldGlowH = line(ax, sx, sy, ...
                "Color", [obj.ColorCyan, 0.3], "LineWidth", 3 * obj.FontScale, ...
                "Tag", "GT_shieldguardian");
            obj.ShieldLineH = line(ax, sx, sy, ...
                "Color", obj.ColorCyan, "LineWidth", 1 * obj.FontScale, ...
                "Tag", "GT_shieldguardian");
        ...
        function onCleanup(obj)
            ...
            % Orphan guard
            engine.GameBase.deleteTaggedGraphics(obj.Ax, "^GT_shieldguardian");
        end
