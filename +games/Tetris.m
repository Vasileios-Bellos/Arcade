    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            for r = 1:obj.NRows
                for c = 1:obj.NCols
                    ...
                    obj.BoardCell(r, c) = patch(ax, "XData", xv, "YData", yv, ...
                        ...
                        "EdgeColor", [0.5 0.5 0.5], "LineWidth", 0.81 * ps, ...
            ...
            obj.FieldBorderH = line(ax, ...
                ...
                "Color", [0, 0.7, 0.85, 0.6], "LineWidth", 1.1 * ps, "Tag", "GT_tetris");
            ...
            for k = 1:4
                obj.ActiveCell(k) = patch(ax, "XData", [0 1 1 0], "YData", [0 0 1 1], ...
                    ...
                    "EdgeColor", [1 1 1], "LineWidth", 0.81 * ps, ...
                    "Visible", "off", "Tag", "GT_tetris");
            end
            ...
            obj.NextBorderH = line(ax, ...
                ...
                "Color", [0, 0.6, 0.7, 0.4], "LineWidth", 0.54 * ps, "Tag", "GT_tetris");
