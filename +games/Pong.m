classdef Pong < GameBase
    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            % Ball aura, glow ring, core (sizes scaled to ball radius)
            r = obj.BallRadius;
            auraSize = max(15, r * 5);
            coreSize = max(6, r * 2);
            glowWidth = max(2, r * 0.6);
            ...
            % Score text (scaled font)
            scoreFontSize = max(8, round(areaH * 0.1));
            obj.ScoreTextH = text(ax, cx, dy(1) + 5, "CPU  0 - 0  YOU", ...
                "Color", [1, 1, 1] * 0.8, "FontSize", scoreFontSize, ...
                "FontWeight", "bold", ...
                "HorizontalAlignment", "center", "VerticalAlignment", "top", ...
                "Tag", "GT_pong");

            % Serve text (scaled font)
            serveFontSize = max(12, round(areaH * 0.18));
            obj.ServeTextH = text(ax, cx, cy, "", ...
                "Color", obj.ColorCyan * 0.9, "FontSize", serveFontSize, ...
                "FontWeight", "bold", ...
