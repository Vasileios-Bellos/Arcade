    ...
    methods
        function onInit(obj, ax, displayRange, ~)
            ...
            obj.BallTrailGlowH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.12], "LineWidth", 8 * obj.FontScale, ...
                "LineStyle", "-", "Tag", "GT_pong");
            obj.BallTrailH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.5], "LineWidth", 2.5 * obj.FontScale, ...
                "LineStyle", "-", "Tag", "GT_pong");

            % Ball aura, glow ring, core (screen-space sizes scaled by ps)
            r = obj.BallRadius;
            auraSize = r * 5 * obj.FontScale;
            coreSize = r * 2 * obj.FontScale;
            ...
            obj.AIPaddleGlowH = patch(ax, ...
                ...
                "LineWidth", 2.5 * obj.FontScale, "Tag", "GT_pong");
            ...
            obj.ScoreTextH = text(ax, cx, dy(1) + 5, "CPU  0 - 0  YOU", ...
                "Color", [1, 1, 1] * 0.8, "FontSize", 26 * obj.FontScale, ...
                "FontWeight", "bold", ...
            ...
            obj.ServeTextH = text(ax, cx, dy(1) + areaH * 0.25, "", ...
                "Color", obj.ColorCyan * 0.9, "FontSize", 47 * obj.FontScale, ...
                "FontWeight", "bold", ...
