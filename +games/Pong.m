    ...
    methods
        function onInit(obj, ax, displayRange, caps)
            ...
            obj.ScoreTextH = text(ax, cx, dy(1) + 5, "CPU  0 - 0  YOU", ...
                "Color", [1, 1, 1] * 0.8, "FontSize", max(8, round(26 * ps)), ...
                "FontWeight", "bold", ...
            ...
            obj.ServeTextH = text(ax, cx, dy(1) + areaH * 0.25, "", ...
                "Color", obj.ColorCyan * 0.9, "FontSize", max(12, round(47 * ps)), ...
                "FontWeight", "bold", ...
            ...
            obj.ComboTextH = text(ax, 0, 0, "", ...
                "Color", obj.ColorGold * 0.8, "FontSize", max(6, round(7 * obj.FontScale)), ...
            ...
            if obj.Serving
                ...
                if obj.ServeCountdown <= 0
                    ...
                    if ~isempty(obj.ServeTextH) && isvalid(obj.ServeTextH)
                        ...
                        obj.ServeTextH.FontSize = max(12, round(16 * obj.FontScale * serveScale));
