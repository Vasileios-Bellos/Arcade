classdef Pong < GameBase
    ...
    methods
        function onInit(obj, ax, displayRange, caps)
            ...
            % Ball: 3 concentric line dot markers (all screen-space, no gaps)
            r = obj.BallRadius;
            obj.BallAuraH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.12], "Marker", ".", ...
                "MarkerSize", r * 5 * ps, "LineStyle", "none", "Tag", "GT_pong");
            obj.BallGlowH = line(ax, NaN, NaN, ...
                "Color", [obj.ColorCyan, 0.35], "Marker", ".", ...
                "MarkerSize", r * 3 * ps, "LineStyle", "none", "Tag", "GT_pong");
            obj.BallCoreH = line(ax, NaN, NaN, ...
                "Color", [1 1 1], "Marker", ".", ...
                "MarkerSize", r * 1.5 * ps, "LineStyle", "none", "Tag", "GT_pong");
