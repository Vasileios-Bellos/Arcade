    ...
    methods (Access = private)
        ...
        function createGraphics(obj)
            ...
            obj.TitleGlowH = text(ax, cx + glowOff, titleY + glowOff, titleStr, ...
                "Color", [0.00 0.35 0.50], "FontUnits", "normalized", "FontSize", obj.TitleFontSize, ...
                "FontWeight", "bold", "HorizontalAlignment", "center", ...
                "VerticalAlignment", "middle", "Tag", tag + "TGlow");
            obj.TitleMainH = text(ax, cx, titleY, titleStr, ...
                "Color", obj.ColorCyan, "FontUnits", "normalized", "FontSize", obj.TitleFontSize, ...
                "FontWeight", "bold", "HorizontalAlignment", "center", ...
            ...
            obj.SubtitleTextH = text(ax, cx, subY, obj.MenuSubtitle, ...
                "Color", [0.25 0.28 0.38], "FontUnits", "normalized", "FontSize", obj.SubtitleFontSize, ...
                "FontWeight", "bold", "HorizontalAlignment", "center", ...
            ...
            for slot = 1:nSlots
                ...
                obj.MenuItemKeyText{slot} = text(ax, badgeX, yMid, "", ...
                    "Color", obj.ColorCyan * 0.50, "FontUnits", "normalized", "FontSize", obj.KeyFontSize, ...
                    "FontWeight", "bold", ...
                ...
                obj.MenuItemNameText{slot} = text(ax, nameX, yMid, "", ...
                    "Color", [0.45 0.47 0.54], "FontUnits", "normalized", "FontSize", obj.NameFontSize, ...
                    "FontWeight", "bold", ...
                ...
                obj.MenuItemScoreText{slot} = text(ax, scoreX, yMid, "", ...
                    "Color", [0.35 0.30 0.15], "FontUnits", "normalized", "FontSize", obj.ScoreFontSize, ...
                    "FontWeight", "bold", ...
            ...
            obj.FooterTextH = text(ax, cx, footY, footStr, ...
                "Color", [0.22 0.24 0.32], "FontUnits", "normalized", "FontSize", obj.FooterFontSize, ...
                "HorizontalAlignment", "center", ...
                "VerticalAlignment", "middle", ...
                "Tag", tag + "Footer");
