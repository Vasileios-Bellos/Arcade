...
Roadmap and issue tracker. See [README.md](README.md) for architecture details.
...
- [ ] HTML port improvements on mobile
...
- [x] README.md - comprehensive architecture, per-game technical notes, all systems documented
