function recordMenu2(outputDir)
%recordMenu2  Record menu with arrow-key navigation through all 15 games.
...
recFps = 30;
framesPerGame = 25;      % ~0.83s per game highlight
settleFrames = 20;       % initial pause on game 1
nGames = 15;
...
% --- Save GIF ---
gifFile = fullfile(outputDir, "menu_scroll_2.gif");
gifFps = 15;
gifDelay = 1 / gifFps;
...
% --- Save MP4 ---
mp4File = fullfile(outputDir, "menu_scroll_2.mp4");
...
fprintf("  Saved menu_scroll_2.gif and menu_scroll_2.mp4 (%d frames)\n", frameIdx);
