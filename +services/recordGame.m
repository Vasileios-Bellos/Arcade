function recordGame(gameName, outputDir, maxRecordFrames)
%recordGame  Play a game with real input while recording.
...
%
%   recordGame("Pong")                    % record until Esc
%   recordGame("Tetris", "assets")        % record until Esc, save to assets/
%   recordGame("Snake", "assets", 600)    % record exactly 600 frames (~10s)
