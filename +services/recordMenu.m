...
for i = 1:size(gameEntries, 1)
    ...
    registryOrder(end + 1) = gameEntries{i, 1}; %#ok<AGROW>
end
...
% --- Save GIF ---
gifFile = fullfile(outputDir, "menu_scroll_4.gif");
gifFps = 15;
gifDelay = 1 / gifFps;
...
% --- Save MP4 ---
mp4File = fullfile(outputDir, "menu_scroll_4.mp4");
...
fprintf("  Saved menu_scroll_4.gif and menu_scroll_4.mp4 (%d frames)\n", frameIdx);
